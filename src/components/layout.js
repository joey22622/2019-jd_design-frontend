...
class Layout extends React.Component {
  state = {
    ...
    navCenter: {
      active: false,
      action: [
        { key: 'collapseNav', active: false },
        { key: 'linkHome', active: false },
        { key: 'collapsePage', active: false },
      ],
      style: {},
    },
    mainStyles: {
  ...
  buildPanelStyle = (elem, i) => {
    ...
    const panelStyles = {
      panel: {
        ...
        height: parseFloat(
          this.state.dimmensions.window.h - this.state.dimmensions.head
        ),
        transform,
      },
      underlay: {
  ...
  handleNav = (e, key) => {
    ...
    const underlay =
      document.querySelector('.panel-underlay').offsetHeight / 2 -
  ...
  handleCoverText = () => {
    if (this.state.coverPanels.loaded) {
      ...
      const margin = parseFloat(
        logo.offsetHeight + logo.getBoundingClientRect().top
      )
  ...
  handleNavCenter = () => {
    ...
    this.state.elements.forEach((elem) => {
      if (elem.active === true) {
        style = {
          height: parseFloat(0.8 * this.state.dimmensions.window.h),
        }
      ...
      <>
        ...
        <div>
          ...
          <div className='side-panels'>
            <div
              className='underlay-left panel-underlay'
              onClick={(e) => {
                this.handleHomeLink(e)
              }}
              onScroll={() => {
                this.handleNav()
              }}
            ...
            >
              <div className='underlay-inner' />
            </div>
            <div
              className='underlay-right panel-underlay'
            ...
            <About data={this.state.elements[0]} />
            <Contact data={this.state.elements[1]} />
          </div>
