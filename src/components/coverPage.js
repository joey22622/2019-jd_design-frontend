...
const CoverPage = (props) => {
      if(props.load){
      return(
        <div className={`cover-panels ${props.data.active}`} >
            <div 
            ...
            <div className="panel panel-left" onClick={(e)=>{props.handleCoverPanels(e)}} style={props.style.panels}>
            ...
            <div className="panel panel-right" onClick={(e)=>{props.handleCoverPanels(e)}} style={props.style.panels}>
            <div className="icon-cutout-wrap">
                <div className="y-margin top-margin"></div>
                <div className="center-row">
                  <div className="x-margin left-margin"></div>
